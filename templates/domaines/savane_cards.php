    ...
    <div class="grid">
      <div class="grid__item">
        <div class="card" data-category="savane">
          <img src="assets/img/domaines/savane/d1-an01-pc01.jpg" loading="lazy" width="365" height="243" alt="Les éléphants" class="card__image" />
          <div class="card__inner">
            <h4>ELEPHANTS</h4>
            <span>Voir la fiche animal</span>
          </div>
        ...
        <div class="modal" id="modal-1">
          ...
          <div class="modal__content">
            <div class="container">
              <div class="grid">
                <div class="grid__item">
                  <img src="https://picsum.photos/600/400?random=2" loading="lazy" width="560" height="373" class="card__image" alt="Projet site de la ville de lyon" />
                  <img src="https://picsum.photos/600/400?random=22" loading="lazy" width="560" height="373" class="card__image" alt="Projet site de la ville de lyon" />
                </div>
                <div class="grid__item">
                  ...
                  <p class="category">
                    <svg width="15" height="15" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="tag" class="svg-inline--fa fa-tag fa-w-16" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
      ...
      <div class="grid__item">
        <div class="card" data-category="design">
          <img src="https://picsum.photos/600/400?random=2" loading="lazy" width="365" height="243" alt="projet de la ville" class="card__image" />
          <div class="card__inner">
      ...
      <div class="grid__item">
        <div class="card" data-category="app">
          <img src="https://picsum.photos/600/400?random=3" loading="lazy" width="365" height="243" alt="projet de la ville" class="card__image" />
          <div class="card__inner">
            <h3 class="card__title">Titre du projet</h3>
      ...
      <div class="grid__item">
        <div class="card" data-category="web">
          <img src="https://picsum.photos/600/400?random=4" loading="lazy" width="365" height="243" alt="projet de la ville" class="card__image" />
          <div class="card__inner">
            <h3 class="card__title">Titre du projet</h3>
      ...
      <div class="grid__item">
        <div class="card" data-category="design">
          <img src="https://picsum.photos/600/400?random=5" loading="lazy" width="365" height="243" alt="projet de la ville" class="card__image" />
          <div class="card__inner">
            <h3 class="card__title">Titre du projet</h3>
            <p class="category">Refonte graphique</p>
          </div>
