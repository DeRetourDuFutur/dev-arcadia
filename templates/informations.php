<!-- Visites | Début -->
<div class="container py-5" id="visites">
  <div class="row g-5 mb-5 wow fadeInUp" data-wow-delay="0.1s">
    <div class="col">
      <p><span class="text-primary me-2">#</span>Préparez votre visite</p>
      <h1 class="display-5 mb-0">Informations pratiques pour préparer votre<span class="text-primary"> visite</span></h1>
    </div>
  </div>
  <div class="container-fluid bg-primary visiting-hours wow fadeInUp py-5 " data-wow-delay="0.1s" id="visites">
    <div class="container pb-5">
      <div class="row g-5">
        ...
        <div class="col-md-6 text-light wow fadeIn" data-wow-delay="0.5s">
          <h1 class="display-6 text-white mb-5">Informations</h1>
          <table class="table">
            <tbody>
              <tr>
                <td>Adresse</td>
                <td>Forêt de Brocéliande</td>
              </tr>
              <tr>
                <td>Zoo</td>
                <td>+33 2 88 88 88 88</td>
              </tr>
              <tr>
                <td>Tickets</td>
                <td>
  ...
  <!-- Informations | Début -->
  <div class="container-xxl" id="informations">
    <div class="container">
      <div class="row g-4">
  ...
  <!-- Chiffres | Début -->
  <div class="container-fluid bg-primary facts py-5 wow fadeInUp" data-wow-delay="0.1s" id="chiffres">
