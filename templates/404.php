<!-- Section 404 | Début -->
<div class="container-xxl py-5 wow fadeInUp" data-wow-delay="0.1s" id="404">
  <div class="container text-center">
    <div class="row justify-content-center">
      <div class="col-lg-6">
        <span class="display-4 text-primary">404</span>
        <br>
        ...
        <p class="mb-4">
          ...
          Ne vous inquiétez pas,<br> ça arrive même aux meilleurs explorateurs ! <br>
          Pour revenir à l'accueil, <span class="text-primary">suivez les pas ...</span>
        </p>
