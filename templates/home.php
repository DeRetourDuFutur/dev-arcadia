...
<div class="home-content">
  ...
  <br>
  Au-delà d'une simple visite, Arcadia vous propose une véritable immersion au cœur du monde sauvage :
  <ul>
    ...
    <li>Participez aux ateliers pédagogiques et animations, animés par des guides passionnés qui vous dévoileront les secrets de la faune et de la flore, vous sensibilisant à la richesse et à la fragilité de la biodiversité.</li>
    <li>Savourez un moment de détente dans nos restaurants et boutiques, où vous pourrez déguster des produits locaux et trouver des souvenirs uniques, prolongeant ainsi l'expérience en ramenant un peu de la magie du parc chez vous. </li>
  </ul>
  ...
  <a class="btn btn-primary-color py-sm-3 px-sm-3 me-5" href="<?= BASE_URL . '/about' ?>">En savoir +</a>
  </p>
</div>
<!-- Contenu HOME | Fin -->
