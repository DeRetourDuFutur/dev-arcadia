...
<div class="slider-animals">
      ...
      <div class="list-slider-animals">
        <div class="item-slider-animals">
          <img
            src="assets/img/animals/covers/arc-sav-cover-slider.webp"
            alt="La Savane"
          />
        ...
        <div class="item-slider-animals">
          <img
            src="assets/img/animals/covers/arc-jun-cover-slider.webp"
            alt="La Jungle"
          />
          <div class="content-slider-animals">
            <div class="author-slider-animals">ARCADIA</div>
        ...
        <div class="item-slider-animals">
          <img
            src="assets/img/animals/covers/arc-swa-cover-slider.webp"
            alt="Les Marais"
          />
          <div class="content-slider-animals">
            <div class="author-slider-animals">ARCADIA</div>
      ...
      <div class="thumbnail-slider-animals">
        <div class="item-slider-animals">
          <img
            src="assets/img/animals/covers/arc-sav-cover-card.jpg"
            alt="La Savane"
          />
          <div class="content-slider-animals">
        ...
        <div class="item-slider-animals">
          <img
            src="assets/img/animals/covers/arc-jun-cover-card.jpg"
            alt="La Jungle"
          />
          <div class="content-slider-animals">
        ...
        <div class="item-slider-animals">
          <img
            src="assets/img/animals/covers/arc-swa-cover-card.jpg"
            alt="Les Marais"
          />
          <div class="content-slider-animals">
